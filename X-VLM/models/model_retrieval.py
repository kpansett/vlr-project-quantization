...
class XVLMEval(XVLM):
    ...
    def forward_eval(self,input_ids, attention_mask):
        text_feat = self.text_encoder(input_ids, attention_mask, mode='text').last_hidden_state
        text_embed = F.normalize(self.text_proj(text_feat[:, 0, :]))
